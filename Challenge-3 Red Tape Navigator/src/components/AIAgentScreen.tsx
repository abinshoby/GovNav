...
import JSONSummaryFormatter from "./JSONSummaryFormatter";
  ...
  const [messages, setMessages] = useState([
    {
      ...
      type: "bot",
      content:
        "Hello! I'm your GovNav AI Assistant. I can help you find local government services, connect with community resources, and answer questions about civic processes. What can I help you with today?",
  ...
  const communityServices = [
    {
      ...
      description:
        "Community centers, sports facilities, and outdoor programs",
      status: "Open",
    ...
    },
    {
      ...
      description:
        "Books, digital resources, community events, and meeting spaces",
      status: "Open",
    ...
    },
    {
      ...
      description:
        "Housing assistance, food programs, and welfare support",
    ...
    },
    {
      ...
      description:
        "Community volunteering opportunities and civic engagement",
      status: "Open",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Get instant help with government services, community
            resources, and civic information
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="formatter" className="flex items-center space-x-2">
          ...
          <TabsContent value="formatter" className="space-y-6">
            <JSONSummaryFormatter 
              onFormatSuccess={(data) => {
                // You can add logic here to handle the formatted data
                // For example, adding it to the chat or storing it
