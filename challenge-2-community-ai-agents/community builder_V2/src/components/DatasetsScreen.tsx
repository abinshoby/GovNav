...
export default function DatasetsScreen() {
  ...
  const datasets = [
    {
      id: 1,
      title: "SAcommunity Service Directory",
      description:
        "A comprehensive directory of community services in South Australia. This is the core dataset for identifying and connecting residents to relevant support services.",
      category: "Community Services",
      format: "CSV",
      size: "2.3 MB",
      lastUpdated: "2024-12-28", // Note: You should use the actual date from the source
      downloads: 1234,
      tags: [
        "community services",
        "support",
      ...
      featured: true,
      link: "https://data.sa.gov.au/data/dataset/sacommunity", // Actual link
    },
    {
      id: 2,
      title: "Ask Izzy Data - Location of Essential Services",
      description:
        "A national dataset from Infoxchange categorizing essential services like food, housing, health, and support. Critical for a multi-jurisdictional agent.",
      category: "Community Services",
      format: "API/CSV",
      size: "15.7 MB",
      ...
      featured: true,
      link: "https://data.gov.au/data/dataset/ask-izzy-data", // Actual link
    },
    {
      id: 3,
      title: "Australian Demographic Statistics (Suburb Level)",
      description:
        "ABS data on population demographics, including age, income, and language spoken at home. Allows the AI to understand community composition and proactively tailor services.",
    ...
    {
      id: 5,
      title: "Community Facilities and Halls",
      description:
        "Locations and details of public community facilities, halls, and spaces. Helps the AI direct users to local events and community engagement opportunities.",
      category: "Community Services",
      format: "CSV",
      size: "12.4 MB",
    ...
    {
      id: 6,
      title: "NDIS Service Providers",
      description:
        "A directory of registered NDIS providers. Essential for the AI to assist residents with disabilities in finding and connecting with approved support services.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Access open government data, reports, and statistics
            to support research, decision-making, and
            transparency.
          </p>
        </div>
